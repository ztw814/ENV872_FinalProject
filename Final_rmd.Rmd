...
----- | -------- | ---------
Age | 1=19 or younger, 2=20-29, 3=30-39, 4=40-49, 5=50-59, 6=60-69, 7=70 or older, 8=Prefer not to answer | 
Gender | 
3. Are seafood values predicted by demographic variables such as age or education level? |   | Age, Gender, Education Level, Political Party, Race, Income Level (6)
...
```{r freq general}
freq.general <- as.data.frame(survey.dat$Frequency_General) 
freq.general <- freq.general %>% 
  mutate(Overall_Frequency = survey.dat$Frequency_General + 1)
